import { View, useColorScheme, StyleSheet, ScrollView, Dimensions, TouchableOpacity } from 'react-native'
...
const Cart = ({ navigation }) => {
    ...
    const scrollHandler = useAnimatedScrollHandler({
        onScroll: (event) => {
            ...
            // if(event.contentOffset.y > placeOrderCompArea.value){
            //     placeOrderComp.value = 0;
            //     placeOrderBorder.value = 0;
            //     placeOrderButton.value = 0;
            //     placeOrderbg.value = 0
            // }else{
            //     placeOrderComp.value = 80
            //     placeOrderBorder.value = 1
            //     placeOrderbg.value = 1
            //     placeOrderButton.value = 40
            // }
